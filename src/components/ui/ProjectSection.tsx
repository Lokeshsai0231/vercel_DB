...
function ProjectCard(props: ProjectCardProps) {
  ...
  return (
    <div className="border rounded-lg dark:border-gray-500 p-4 dark:hover:border-white cursor-pointer flex flex-col gap-4 transition-all">
      {/* 1st */}
      <section className="flex justify-between items-center">
        {/* left */}
        <section className="flex gap-4 ">
          <div className=" h-8 w-8 flex items-center justify-center border ms:h-12 sm:w-12 rounded-full dark:border-gray-700">
      ...
      <div className="text-gray-400">
        {/* last commite message */}
        <p className=" hover:underline transition-all">{lastCommit}</p>
        <p className="flex gap-1 items-center">
          <span className="dark:text-white">{lastCommitTime} ago on</span>
          <FaCodeBranch className="text-xl dark:text-white" />{" "}
